...
class SelectLanguageActivity : BaseActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val languages = mutableListOf(
            Language(
                Constants.Language.CODE_ENGLISH,
                Constants.Language.ENGLISH,
                Constants.Language.LAN_ENGLISH,
                R.drawable.flag_english
            ),
            Language(
                Constants.Language.CODE_SPANISH,
                Constants.Language.SPANISH,
                Constants.Language.LAN_SPANISH,
                R.drawable.flag_spanish
            ),
            Language(
                Constants.Language.CODE_FRENCH,
                Constants.Language.FRENCH,
                Constants.Language.LAN_FRENCH,
                R.drawable.flag_french
            ),
            Language(
                Constants.Language.CODE_HINDI,
                Constants.Language.HINDI,
                Constants.Language.LAN_HINDI,
                R.drawable.flag_hindi
            ),
            Language(
                Constants.Language.CODE_CHINESE,
                Constants.Language.CHINESE,
                Constants.Language.LAN_CHINESE,
                R.drawable.flag_chinese
            ),
            Language(
                Constants.Language.CODE_ARABIC,
                Constants.Language.ARABIC,
                Constants.Language.LAN_ARABIC,
                R.drawable.flag_arabic
            ),
            Language(
                Constants.Language.CODE_RUSSIAN,
                Constants.Language.RUSSIAN,
                Constants.Language.LAN_RUSSIAN,
                R.drawable.flag_russian
            ),
            Language(
                Constants.Language.CODE_PORTUGUESE,
                Constants.Language.PORTUGUESE,
                Constants.Language.LAN_PORTUGUESE,
                R.drawable.flag_portuguese
            ),
            Language(
                Constants.Language.CODE_ITALIAN,
                Constants.Language.ITALIAN,
                Constants.Language.LAN_ITALIAN,
                R.drawable.flag_italian
            ),
            Language(
                Constants.Language.CODE_GERMAN,
                Constants.Language.GERMAN,
                Constants.Language.LAN_GERMAN,
                R.drawable.flag_german
            ),
            Language(
                Constants.Language.CODE_JAPANESE,
                Constants.Language.JAPANESE,
                Constants.Language.LAN_JAPANESE,
                R.drawable.flag_japanese
            ),
            Language(
                Constants.Language.CODE_URDU,
                Constants.Language.URDU,
                Constants.Language.LAN_URDU,
                R.drawable.flag_urdu
            ),
            Language(
                Constants.Language.CODE_AFRIKAANS,
                Constants.Language.AFRIKAANS,
                Constants.Language.LAN_AFRIKAANS,
                R.drawable.flag_afrikaans
            ),
            Language(
                Constants.Language.CODE_AMHARIC,
                Constants.Language.AMHARIC,
                Constants.Language.LAN_AMHARIC,
                R.drawable.flag_amharic
            ),
        )
        ...
        when(v?.id){
            R.id.btnNext ->{
                ...
                if (from == Constants.SPLASH) {
                    ...
                    intent.putExtra(Constants.OPEN_FRAGMENT, Constants.SETTINGS_FRAGMENT)
                    startActivity(intent)
